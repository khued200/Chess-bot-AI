...
class Game:
    ...
    def move_handler(self, window, board, player, move, original_sq, new_sq, current_piece):
        ...
        #elif board.is_enpassant(move): #en_passant
        #    self.board_array[original_sq[0]][original_sq[1]] = constants.BLANK   # Clear original square [row,col]
        #    self.board_array[new_sq[0]][new_sq[1]] = current_piece
        #    change = -1 
        #    if(self.is_player_white): change = 1
        #    self.board_array[new_sq[0] + change][new_sq[1]] = constants.BLANK#fix tam
